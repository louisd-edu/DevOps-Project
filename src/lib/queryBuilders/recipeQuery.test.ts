...
describe('buildRecipeQuery', () => {
	...
	it('should build a basic query with default options', () => {
		...
		expect(mockQuery.order).toHaveBeenCalledWith('recipename', { ascending: true });
	...
	it('should apply cuisine filter when provided', () => {
		...
		expect(mockQuery.in).toHaveBeenCalledWith('cuisine', ['Italian', 'Mexican']);
	});
	...
	it('should apply text search with prefix matching', () => {
		...
		expect(mockQuery.textSearch).toHaveBeenCalledWith('search_tsv', 'pasta:* & carbonara:*');
	});
	...
	it('should sort by name in descending order', () => {
		...
		expect(mockQuery.order).toHaveBeenCalledWith('recipename', { ascending: false });
	});
